...
#define OFFSET_ENTITYLIST		        0x18C7AF8		//cl_entitylist
#define OFFSET_LOCAL_ENT			0x1C76FB8		//LocalPlayer

#define OFFSET_VISIBLE_TIME         0x1A6C			//visibility check

#define OFFSET_TEAM					0x430			//m_iTeamNum
#define OFFSET_HEALTH				0x420			//m_iHealth
#define OFFSET_NAME					0x569			//m_iName
#define OFFSET_SIG_NAME				0x0560			//m_iSignifierName
#define OFFSET_SHIELD				0x170			//m_shieldHealth
#define OFFSET_MAX_SHIELD			0x170			//m_shieldHealth +0x4

#define OFFSET_LIFE_STATE			0x778			//m_lifeState
#define OFFSET_BLEED_OUT_STATE		0x2628			//m_bleedoutState

#define OFFSET_ITEM_ID				0x1608			//m_customScriptInt

#define OFFSET_BULLET_SPEED			0x1e1c			//m_flProjectileSpeed
#define OFFSET_BULLET_GRAVITY		0x1E24			//m_flProjectileScale
...
#define OFFSET_HELMET_TYPE			0x4294			//m_helmetType
...
#define OFFSET_RENDER				0x4077BD8 	 	//ViewRender